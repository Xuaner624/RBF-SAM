...
SAVE_PATH = '/root/autodl-tmp/RBF-SAM-main/results/rbf_sam_bonai_vis'
ANN_COCO = COCO(
...
def _draw_boundary_offset(id, coco: COCO, save_dir=SAVE_PATH):
    ...
    image = cv2.imread(os.path.join('/root/autodl-tmp/data/BONAI/test', img['file_name']))
...
if __name__ == '__main__':
    vis_boundary_offset('/root/autodl-tmp/RBF-SAM-main/results/rbf_sam_bonai/rbf_sam_bonai.json',
                        '/root/autodl-tmp/RBF-SAM-main/results/rbf_sam_bonai_vis')
