...
def parse_args():
    ...
    parser.add_argument('--checkpoint',
                        default='results/rbf_sam_omnicity/rbf_sam_omnicity_epoch_48.pth',
...
js = json.load(open('/root/autodl-tmp/data/OmniCityView3WithOffset/coco/OmniCityView3WithOffset_test_roof.json'))
# js = json.load(open('D:/off_nadir_building/data/OmniCityView3WithOffset/coco/OmniCityView3WithOffset_test_roof.json'))
...
def search_ann_id(bbox, img_id, key, coco=COCO('/root/autodl-tmp/data/OmniCityView3WithOffset/coco/OmniCityView3WithOffset_test_roof.json')):
                  # coco=COCO('D:/off_nadir_building/data/OmniCityView3WithOffset/coco/OmniCityView3WithOffset_test_roof.json')):
...
def main():
    ...
    save_dir = os.path.abspath('./results/rbf_sam_omnicity')
