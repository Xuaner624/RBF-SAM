...
def parse_args():
    ...
    parser.add_argument('--config',
                        default="configs/rbf_sam/rbf_sam_huizhou.py",
...
js = json.load(open('/root/autodl-tmp/data/BONAI/coco/building_seg_obm_huizhou_test.json'))
# js = json.load(open('D:/off_nadir_building/data/BONAI/coco/building_seg_obm_huizhou_test.json'))
...
def search_ann_id(bbox, img_id, key, coco=COCO('/root/autodl-tmp/data/BONAI/coco/building_seg_obm_huizhou_test.json')):
                  # coco=COCO('D:/off_nadir_building/data/BONAI/coco/building_seg_obm_huizhou_test.json')):
...
def main():
    ...
    save_dir = os.path.abspath('./results/rbf_sam_huizhou')
