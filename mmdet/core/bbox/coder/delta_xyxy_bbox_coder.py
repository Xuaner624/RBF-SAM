...
#         bboxes = torch.Tensor([[0, 0, self.image_size[0], self.image_size[1]]]).to(gt_bboxes.device).repeat(
#             gt_bboxes.size(0), 1)
...
#         bboxes = torch.Tensor([[0, 0, self.image_size[0], self.image_size[1]]]).to(pred_bboxes.device).repeat(
#             pred_bboxes.size(0), 1)
